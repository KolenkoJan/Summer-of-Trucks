...
export const LogInRoute: React.FC = observer(() => {
    ...
    return (
        <div className="flex flex-1 flex-column justify-center items-center padding-xl">
            <div className="flex justify-center items-center">
                <Card className="items-center overflow-hidden">
                    <div className="flex flex-column items-center">
                        <div className="center-content">
                            <InovaLogoIcon />
                            <h1 className="text-size padding-top-xl">PARKPLAC POLETJE</h1>
                        </div>
                        <div className="bottom-content">
                            <Text> Vpišite se z računom google</Text>
                            <Button
                                className="flex flex-1 justify-center items-center margin-top-xl profile-button"
                            ...
                            <Button
                                className="flex flex-1 justify-center items-center margin-top-m profile-button"
                                onClick={() => AuthService.signInWithGoogleAsAdmin(navigate)}
                                leftIcon={
                                    <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="-3 0 262 262" preserveAspectRatio="xMidYMid">
                                        <path
                                            d="M255.878 133.451c0-10.734-.871-18.567-2.756-26.69H130.55v48.448h71.947c-1.45 12.04-9.283 30.172-26.69 42.356l-.244 1.622 38.755 30.023 2.685.268c24.659-22.774 38.875-56.282 38.875-96.027"
